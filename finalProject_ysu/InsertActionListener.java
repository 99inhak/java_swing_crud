...
public class InsertActionListener implements ActionListener { // 추가 버튼 눌렀을 때
    JTable table;
    JTextField text1, text2, text3;
    
    InsertActionListener(JTable table, JTextField text1, JTextField text2, JTextField text3) {
        this.table = table;
        this.text1 = text1;
        this.text2 = text2;
        this.text3 = text3;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
        	...
        	// 레코드 추가하기
        	stmt.executeUpdate("insert into studentinfo (name, address, phoneno) values ('"
